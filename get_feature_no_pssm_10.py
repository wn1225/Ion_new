...
def main():
    ...
    ff = open(feature+'40%_feature_no_pssm.txt', 'w')

    label_file = label+'40%_T_label.txt'

    surface_file = surface+'surface_total.txt'
    ...
    with open(label_file, 'r') as fp, open(surface_file) as fp3:
        ...
        for line1 in fp:  # line1:str '>3jcx-A\n'
            ...
            if line1.startswith('>'):
                ...
                seq = row1[0][6]
                file = ipath+'model_one_pdb/' + file_name.lower() + '_' + seq + '.pdb'
